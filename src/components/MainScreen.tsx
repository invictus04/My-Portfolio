...
export function MainScreen() {
    ...
    const handleDownload = () => {
        ...
        link.href = "/assets/Raj_Resume.pdf"; // File in public/assets
    ...
    return (
        <div className="flex items-center justify-center min-h-screen w-full bg-black/[0.96] antialiased relative overflow-hidden">
            ...
            <div className="p-4 max-w-7xl mx-auto relative z-10 w-full">
                <h1 className="leading-tight font-mono text-5xl md:text-6xl sm:text-4xl font-bold text-center bg-clip-text text-transparent bg-gradient-to-b from-neutral-50 to-neutral-400 bg-opacity-50">
                ...
                <div className="flex justify-center mt-16 space-x-13">
                    <RainbowButton
                        size="lg"
                        variant="outline"
                        className="text-neutral-300 transition-transform duration-300 hover:translate-y-[-2px] hover:shadow-lg cursor-pointer"
