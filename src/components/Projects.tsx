  ...
  return (
    <section className="py-10 w-full min-h-screen bg-black">
      ...
      {projects.map((item, index) => (
        <div
          className="rounded-xl p-6 w-full max-w-4xl mx-auto flex items-center gap-6 mb-8"
          key={index}
        >
          <div className="flex-shrink-0 w-32 h-32 rounded-lg overflow-hidden">
            {/* The src can now be simplified */}
            <img
              src={item.imageUrl}
              alt="Project Preview"
          ...
          <div className="flex flex-col">
            <h3 className="text-xl font-semibold text-[#a3cef1] mb-1">
              {item.title}
            </h3>
            <p className="text-[#e7ecef] text-base leading-relaxed">
              {item.description}
            </p>
          </div>
          <a
            ...
            className="ml-auto"
          >
            <InteractiveHoverButton className="text-[#e7ecef]">
              Project
